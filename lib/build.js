...
module.exports = {
  ...
  activate: function(state) {
    ...
    this.errorMatcher.on('scroll', function(type, id) {
      this.buildView.scrollTo(type, id);
    }.bind(this));

    this.errorMatcher.on('replace', function(text, onclick) {
      this.buildView.replace(text, onclick);
    }.bind(this));
